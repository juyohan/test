...
@ToString
@Entity
public class UserScheduleThursday {

    @Id
    @Column(name="USERSCHEDULETHURSDAY_ID")
    ...
    public UserScheduleThursday(String subteacher, String subroom, Long subtime){
        this.subteacher = subteacher;
        this.subroom = subroom;
        this.subtime = subtime;
    }
    public UserScheduleThursday(){}

    @OneToMany(mappedBy = "userScheduleThursday", fetch = FetchType.EAGER, cascade = CascadeType.ALL)
